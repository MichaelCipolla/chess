...
public static class ShaderHighlighter
{
    ...
    static Dictionary<string, string> colorTable = new Dictionary<string, string> {
        ...
        { "function",    Common.Color.function },
        { "className",   Common.Color.className },
    ...
    static void Init()
    {
        ...
        var patterns = new string[] { 
            ...
            string.Format(pattern1, "function", string.Join("|", ShaderSyntax.function)),
            string.Format(pattern1, "className", string.Join("|", ShaderSyntax.className)),
